...
public class AzTask extends Task {
    ...
    public AzTask(AzDoRepository azDoRepository, TaskType taskType, boolean isClosed, WorkItemModel workItemModel) {
    ...
    public @NotNull Icon getIcon() {
        ...
        final Icon icon = azDoRepository.icons.getOrDefault(type, AllIcons.FileTypes.Any_type);
        return icon;
    }
